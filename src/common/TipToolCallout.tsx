...
import { Callout, Link, mergeStyleSets, Text, FontWeights, IconButton, DirectionalHint } from '@fluentui/react';
...
export function TipToolCallout(props: ITipToolCalloutProps) {
