...
export interface ISPChoiceProps {
    Label: string;
    Data?: any;
    Value?: string | number;
    FieldName?: string;
    Choices: IChoiceGroupOption[];
    Layout?: SPChoiceLayout;
...
export enum SPChoiceLayout {
    Vertical,
    Horizontal
}

export const SPChoice: React.FunctionComponent<ISPChoiceProps> = React.forwardRef<HTMLElement, ISPChoiceProps>(
    (props, forwardedRef) => {
        ...
        const HorizontalLayout = props.Layout === SPChoiceLayout.Horizontal ? styles.SPChoiceHorizontal : undefined;
        ...
        return (
            <div className={styles.fieldContainer}>
                ...
                {!(_fieldActions.isReadOnly()) ?
                    ...
                    /> :
                    <div className={props.Layout === SPChoiceLayout.Horizontal ?
