...
export interface ISPFxPercentageFieldProps {
    Label?: string;
    Value?: string;
    Data?: any;
    DecimalScale?: number;
...
export const SPFxPercentageField: React.FunctionComponent<ISPFxPercentageFieldProps> = React.forwardRef<HTMLElement, ISPFxPercentageFieldProps>(
    (props, forwardedRef) => {
